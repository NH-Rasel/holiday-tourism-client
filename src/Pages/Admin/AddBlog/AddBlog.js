    ...
    return (
        <div className="container  m-5">
            ...
            <form className="p-4" style={{ border: '2px solid lightgray', borderRadius: '10px', width: 'auto' }} onSubmit={handleAddBlog}>
                ...
                <div class="form-floating mb-3">
                    <input type="value" class="form-control" id="floatingInput" ref={writerRef} placeholder="Price URL" />
                    <label for="floatingInput">Writer</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="value" class="form-control" id="floatingInput" ref={dateRef} placeholder="Price URL" />
